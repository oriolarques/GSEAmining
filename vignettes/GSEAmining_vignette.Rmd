...
# Overview
Gene Set Enrichment Analysis ([GSEA](https://www.gsea-msigdb.org/gsea/doc/GSEAUserGuideFrame.html)) 
is a very powerful and interesting computation method that allows and easy 
...
Many available tools rely o hierarchically structured Gene Ontology (GO) 
...
different colors (blue and red respectively but that can be chosen by the user).
